...
const AwardWinners = () => {
  ...
  // Filter and sort award-winning books
  const awardWinningBooks = Array.isArray(books)
    ? books
        .filter(book => book.awardWinner) // Only include books marked as award winners
        .filter(book => {
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold mb-8 text-center">Award Winners</h1>
  ...
  if (isError) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-12 text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">There was a problem loading award-winning books. Please try again later.</p>
        <button
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Explore our collection of critically acclaimed books that have won prestigious literary awards.
        </p>
      </div>
        ...
        <div className="flex-1">
          {awardWinningBooks.length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-xl border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">No Award Winners Found</h3>
              <p className="text-gray-600 mb-6">
                No books match your current filters or there are no award winners available.
              </p>
              <button
                onClick={resetFilters}
                className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="text-gray-600">
                  Showing <span className="font-medium">{awardWinningBooks.length}</span> award winners
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-8">
                {awardWinningBooks.map((book) => (
