...
const NewArrival = () => {
  ...
  const filteredBooks = Array.isArray(books)
    ? books
        ...
        .sort((a, b) => {
          if (sortBy === "newest") {
            return new Date(b.createdAt || b.publishDate || 0) - new Date(a.createdAt || a.publishDate || 0);
        ...
        // Only take the first 30 days of books to ensure they're "new arrivals"
        .filter(book => {
          const creationDate = new Date(book.createdAt || book.publishDate || 0);
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold mb-8 text-center">New Arrivals</h1>
  ...
  if (isError) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-12 text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">There was a problem loading new arrivals. Please try again later.</p>
        <button
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Discover our latest additions to our collection. These books have been added in the last 30 days.
        </p>
      </div>
        ...
        <div className="flex-1">
          {filteredBooks.length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-xl border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">No New Arrivals Found</h3>
              <p className="text-gray-600 mb-6">
                No books match your current filters or there are no new arrivals in the last 30 days.
              </p>
              <button
                onClick={resetFilters}
                className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="text-gray-600">
                  Showing <span className="font-medium">{filteredBooks.length}</span> new arrivals
                </p>
              </div>
