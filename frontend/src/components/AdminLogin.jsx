...
const AdminLogin = () => {
    ...
    return (
        <div className='min-h-screen flex justify-center items-center bg-gradient-to-r from-blue-50 to-indigo-50'>
            <div className='w-full max-w-md mx-auto bg-white shadow-2xl rounded-xl px-8 pt-8 pb-10 mb-4 border border-gray-100'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className='pl-10 shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200'
                            />
                        </div>
                    ...
                    {message && (
                        <div className='p-3 bg-red-50 border-l-4 border-red-500 text-red-700 rounded-md flex items-center'>
